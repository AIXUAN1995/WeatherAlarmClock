...
//        Log.d("activity","onCreate");
        ...
        SetSettingButton();
        if (NetworkTool.ping()){
            Toast.makeText(AlarmActivity.this, "网络连接正常", Toast.LENGTH_SHORT).show();
            System.out.println("###网络连接正常");
        }else{
            Toast.makeText(AlarmActivity.this, "网络连接不正常", Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.checkBox_alarm_active) {
            ...
            if (checkBox.isChecked()) {
                ...
                AlarmActivity.this.CancelAlarmServiceBroadcastReciever(alarm);
                Toast.makeText(AlarmActivity.this, "闹钟已取消", Toast.LENGTH_SHORT).show();
            }
        }
    }
                ...
                public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long id) {
                    ...
                    dialog.setNegativeButton("删除", new OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            System.out.println("####getAlarmRequestCode()"+alarm.getAlarmRequestCode());
                            //取消
                            AlarmActivity.this.CancelAlarmServiceBroadcastReciever(alarm);
                            updateAlarmList();
                        }
