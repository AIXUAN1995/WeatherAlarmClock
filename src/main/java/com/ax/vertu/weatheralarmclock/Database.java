...
public class Database extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_ALARM_REQUESTCODE = "alarm_requestCode";
    ...
    public static long create(Alarm alarm) {
        ...
        cv.put(COLUMN_ALARM_REQUESTCODE, alarm.getAlarmRequestCode());
    ...
    public static Alarm getAlarm(int id) {
        ...
        if (c.moveToFirst()) {
            ...
            alarm.setAlarmRequestCode(c.getInt(9));
        }
        c.close();
        return alarm;
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS " + ALARM_TABLE + " ( "
                ...
                + COLUMN_ALARM_REQUESTCODE + " INTEGER NOT NULL)");
    }
    ...
    public static List<Alarm> getAll() {
        ...
        if (cursor.moveToFirst()) {
            ...
            do {
                ...
                alarm.setAlarmRequestCode(cursor.getInt(7));
